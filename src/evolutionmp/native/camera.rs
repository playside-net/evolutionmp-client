...
pub fn new<H>(name: H, unknown: bool) -> Handle where H: Hashable {
...
pub fn destroy(handle: Handle, check_this_script: bool) {
...
pub fn get_fov(handle: Handle) -> f32 {
    invoke!(f32, 0xC3330A45CCCDB26A, handle)
}

pub fn get_near_clip(handle: Handle) -> f32 {
    invoke!(f32, 0xC520A34DAFBF24B1, handle)
}

pub fn get_far_clip(handle: Handle) -> f32 {
